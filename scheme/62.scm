...
;;          ;; (cons env (cdr (base-eval
;;          ;;                 (define-var (extend-env (closure-env fun)) (car (closure-params fun)) (car args))
;;          ;;                 (closure-body fun))))
         
;;          ;; ;; TODO
;;          (let* ((env-in (closure-env fun))
;;                 (params (closure-params fun))
;;                 (body (closure-body fun)))
;;            (list env (cadr (base-eval (define-var (extend-env env-in) (car params) (car args)) body)))
;;            )
;;          )
